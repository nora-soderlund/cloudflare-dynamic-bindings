import { D1DatabasePolyfill } from "./polyfills/D1Database";
...
export function getD1DatabaseBinding(token: string, accountId: string, databaseId: string): D1DatabasePolyfill {
  return new D1DatabasePolyfill(token, accountId, databaseId);
}
